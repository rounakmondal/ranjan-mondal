    ...
    <section id="about" class="about container">
        ...
        <div class="container p-5" data-aos="fade-up">
          ...
          <div class="row">
            <div class="col-lg-4">
              <img src="assets/img/ranjan.jpeg" class="img-fluid" alt="">
            </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul>
                    ...
                    <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>7001518961</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span> Durgapur, West-Bengal</span></li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul>
                    ...
                    <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>rounakmondal198@gmail.com</span></li>
